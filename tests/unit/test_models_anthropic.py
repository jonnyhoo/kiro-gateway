...
class TestAnthropicMessagesRequestWithImages:
    ...
    def test_request_preserves_message_cache_control_in_model_dump(self):
        """
        What it does: Verifies message-level cache_control survives request serialization.
        Purpose: Ensure explicit Anthropic prompt caching on message blocks is preserved.
        """
        print("Setup: Creating AnthropicMessagesRequest with message cache_control...")
        request = AnthropicMessagesRequest(
            model="claude-sonnet-4-5",
            max_tokens=128,
            messages=[
        ...
        print("Action: Serializing request via model_dump...")
...
class TestTextContentBlock:
    ...
    def test_preserves_cache_control(self):
        """
        What it does: Verifies TextContentBlock keeps cache_control metadata.
        Purpose: Ensure Anthropic message-level prompt caching survives validation.
        """
        print("Setup: Creating TextContentBlock with cache_control...")
